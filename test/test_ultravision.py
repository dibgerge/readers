...
class TestUV(unittest.TestCase):
    ...
    def test_no_parameters(self):
        out = readers.read_ultravision(self.fname)
        self.assertIsInstance(out, dict)

    def test_with_parameters(self):
        out = readers.read_ultravision(self.fname, [45]*self.ntheta, 100e6, 3260)
    ...
    def test_wrong_parameters(self):
        ...
        self.assertRaises(ValueError, lambda: readers.read_ultravision(self.fname,
                                                                       [45]*(self.ntheta - 2),
                                                                       100e6, 3260))
